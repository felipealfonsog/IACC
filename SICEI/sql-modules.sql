...
SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERRO R_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION'; DROP SCHEMA IF EXISTS `db_edusys` ;
CREATE SCHEMA IF NOT EXISTS `db_edusys` DEFAULT CHARACTER SET utf8 ; USE `db_edusys` ;
